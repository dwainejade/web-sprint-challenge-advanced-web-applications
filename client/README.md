...
1. Explain what a token is used for.
  - tokens are used as a uniquw identifier for a user.

2. What steps can you take in your web apps to keep your data secure?
  - generate tokens and make protected routes.

3. Describe how web servers work.
  - servers store webpages. The recieve request and process and deliver data to the requester.
